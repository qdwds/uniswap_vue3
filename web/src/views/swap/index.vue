<template>
    <div>
        ...
        <Config></Config>
        <el-button type="primary" size="large" @click="exchange">兑换</el-button>
...
import Config from "../../components/Swap/Config.vue";
...
const handleTokenAll1 = () => {
    token1.input = token1.balance;
}
const handleTokenAll2 = () => {
    token2.input = token2.balance;
}
</script>
<style>
*{
